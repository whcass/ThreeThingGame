    ...
    public class Game1 : Game
    {
        ...
        private void LoadXmlStuff(XmlDocument XmlFile)
        {
            ...
            foreach (XmlNode lPlatform in LevelNode.SelectSingleNode("Platforms").ChildNodes)
            {
                ...
                int crackerWidth = screenWidth / 1;
                ...
                BasicPlatform basicPlatform  = new BasicPlatform(screenWidth, screenHeight, Pixel, crackerWidth, 0, 0,ChildNodeStringFromParent(lPlatform, "Name"));
